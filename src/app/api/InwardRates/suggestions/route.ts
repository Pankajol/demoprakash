...
//     console.log('Company code from token:', payload.companyCode);

//     // Fetch distinct ItemNames
...
//     const itemNames = itemResult.recordset.map((row: any) => row.ItemName);
//     const supplierIds = supplierResult.recordset.map((row: any) => row.SupplierName?.toString());

//     console.log('Item names fetched:', itemNames);
//     console.log('Supplier names fetched:', supplierIds);
